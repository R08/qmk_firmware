...
//-|-----------|---------------------------------------------------------------------------------------------------------------------------------|||-----------------------------
     _______,    _______,   _______,  _______,  _______,  _______,  _______,  KC_HOME,  WRD_LEFT, WRD_RIGHT, KC_END,  _______,  _______,  _______,    _______,  _______,  _______,
//-|-----------|---------------------------------------------------------------------------------------------------------------------------------|||-----------------------------
     _______,    HR_A,      HR_S,     HR_D,     HR_F,     _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT,  _______, _______,            _______,
//-|---------------------------------------------------------------------------------------------------------------------------------------------|||-----------------------------
     _______,               KC_LCTL,  KC_LSFT,  _______,  _______,  LCTL(KC_B),  _______,  _______,  _______,  _______,  _______,         _______,              _______,
//-|-----------|---------------------------------------------------------------------------------------------------------------------------------|||-----------------------------
